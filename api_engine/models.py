...
class Usuarios(models.Model):
  nome_site = models.CharField(max_length=500,default='',primary_key=True)
  nome = models.CharField(max_length=500,default='')
  senha = models.IntegerField(default=0)

  
class Listas(models.Model):
  quando = models.CharField(max_length=500,default='',primary_key=True)
...
class Participacoes(models.Model):
  participante =  models.CharField(max_length=500,default='',primary_key=True)
